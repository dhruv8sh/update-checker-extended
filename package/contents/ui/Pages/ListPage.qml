    ...
    header:QQC2.ToolBar{
        ...
        RowLayout{
            ...
            QQC2.ToolButton {
                ...
                Layout.alignment: Qt.AlignRight
                onClicked: {
                    filterModel.sortOrder == Qt.AscendingOrder ? Qt.DescendingOrder : Qt.AscendingOrder
                    if(toolbar.ascending) curr ++;
                    if( curr > 2 ) curr = 0;
                    filterModel.sortRoleName = sortable[curr][0];
                }
                display:QQC2.AbstractButton.IconOnly
        ...
        footer:QQC2.ToolBar{
            RowLayout{
                ...
                QQC2.ToolButton {
                    ...
                    PlasmaComponents.ToolTip{ text: i18n("Extra Actions") }
                }
            }
        }
        ...
        contentItem: Item{
            ...
            ColumnLayout{
                ...
                Common.CustomScroll {
                    child: Common.PackageItem {
                        showSeparator: index !== 0
                        Layout.fillWidth: true
                    }
                    searchMode: toolbar.searchTerm!==""
                    fModel: filterModel
                }
            }
